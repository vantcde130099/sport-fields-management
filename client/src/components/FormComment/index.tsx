...
//material-ui
import { Divider, Box, Button, ButtonBase, Grid, Paper, TextareaAutosize, Typography } from '@material-ui/core'
      ...
      >
        ...
        <Paper className={classes.paper} style={{ width: '100%' }}>
          ...
          <TextareaAutosize value={valueArea} rowsMax={4} onChange={(e: any) => changeSizeArea(e)}
            ...
            placeholder="Bình Luận Tại Đây ......" rowsMin={4} style={{ width: '100%', height: "150px", marginTop: 8 }} />
        </Paper>
