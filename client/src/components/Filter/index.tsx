 ...
 */
export const SearchFilter: React.FC<Props> = ({ listCity , listDistrict ,...props }) => {
          ...
          <Grid container className={classes.root} spacing={2}>
            ...
            >
              <FormControl variant="outlined" className={classes.formControl}>
                ...
                >
                  {listCity?.map((city , index)=><option value={index}>{city}</option>)}
                </Select>
              </FormControl>
              <FormControl variant="outlined" className={classes.formControl}>
                <InputLabel htmlFor="outlined-age-native-simple">
                ...
                >
                  {listDistrict?.map((district , index)=><option value={index}>{district}</option>)}
                </Select>
              </FormControl>
              <FormControl variant="outlined" className={classes.formControl}>
                <TextField
